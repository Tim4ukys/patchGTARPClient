[![GitHub license](https://img.shields.io/github/license/Tim4ukys/patchGTARPClient?style=flat-square)](https://github.com/Tim4ukys/patchGTARPClient/blob/main/LICENSE)
...
Распаковываем всё содержимое архива "_updater_patchGTARPclient.7z_" тот же корень игры. Всё, теперь при выходе обновления при входе в игру у вас будет открываться окно. Следуйте инструкциям в нём и всё будет alright.
